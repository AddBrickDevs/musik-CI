...
<html>
    <head>
        <meta charset="UTF-8">
        <title>My Music Site [Admin] | <?php echo $title; ?></title>
                      ...
                      ed.addButton('playlist', {
                                ...
                                menu: [
                                    <?php foreach ($my_playlist->result()  as $row) { ?>
                                        {text: '<?php echo $row->name; ?>', onclick: function() {ed.insertContent('[custom type="playlist" id="<?php echo $row->idplaylist; ?>" ]');}},
                                    <?php }   ?>

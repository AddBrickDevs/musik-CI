...
<tr>
	...
	<?php if($this->config->item("newsletter_mod_recommended") == '1'){ ?>
				...
				<tr>
					...
					<td valign="top" align="left">
						...
						<td width="10" class="s">&nbsp;</td>
							...
							<div ><p>
								 <a style="color:#5ca8cd;text-decoration:none" href="<?php echo $this->config->item("newsletter_base_url") ; ?>artist/<?php echo encode($row->name); ?>"><img src="<?php echo $image; ?>" height="172"  width="172" style="width:172px;height:172px"></a>
							</p></div>
		...
		<?php } ?>
		<?php if($this->config->item("newsletter_mod_the_most_listened") == '1'){ ?>
		<table width="790" cellspacing="0" cellpadding="0" class="wrap body" style="background-color:#FFFFFF">
					...
					foreach($top->result() as $row){ 
						...
						<td valign="top" align="left">
							...
							<td width="10" class="s">&nbsp;</td>
								...
								<div ><p>
									 <a style="color:#5ca8cd;text-decoration:none" href="<?php echo $this->config->item("newsletter_base_url") ; ?>?artist=<?php echo encode($row->artist); ?>&track=<?php echo encode($row->track); ?>" ><img src="<?php echo $row->picture; ?>"   height="172"  width="172" style="width:172px;height:172px"></a>
								</p></div>
								<div class="btn"><buttons>
		...
		<?php } ?>
		<?php if($this->config->item("newsletter_mod_top_artist_weekend") == '1'){ ?>
					...
					foreach($topA->result() as $row){ 
						...
						<td valign="top" align="left">
							...
							<td width="10" class="s">&nbsp;</td>
								...
								<div ><p>
									 <a style="color:#5ca8cd;text-decoration:none" href="<?php echo $this->config->item("newsletter_base_url") ; ?>artist/<?php echo encode($row->artist); ?>" ><img src="<?php echo $row->picture; ?>"  height="172"  width="172"  style="width:172px;height:172px"></a>
								</p></div>
								<div class="btn"><buttons>
								<strong><a style="color:#5ca8cd;text-decoration:none" href="<?php echo $this->config->item("newsletter_base_url") ; ?>artist/<?php echo encode($row->artist); ?>" ><?php echo $row->artist; ?></a></strong><br>								
								</buttons></div>
		...
		<?php } ?>
		<?php if($this->config->item("newsletter_mod_trending_now") == '1'){ ?>
		<table width="790" cellspacing="0" cellpadding="0" class="wrap body" style="background-color:#FFFFFF">
					...
					foreach($activity->result() as $row){ 
						...
						<td valign="top" align="left">
							...
							<td width="10" class="s">&nbsp;</td>
								...
								<div ><p>
									 <a style="color:#5ca8cd;text-decoration:none" href="<?php echo $this->config->item("newsletter_base_url") ; ?>?artist=<?php echo encode($row->artist); ?>&track=<?php echo encode($row->track); ?>" ><img  height="172"  width="172" src="<?php echo $row->picture; ?>"  style="width:172px;height:172px"></a>
								</p></div>
								<div class="btn"><buttons>
								<strong><a style="color:#5ca8cd;text-decoration:none" href="<?php echo $this->config->item("newsletter_base_url") ; ?>artist/<?php echo encode($row->artist); ?>" ><?php echo $row->artist; ?></a></strong><br>
								<a style="color:#5ca8cd;text-decoration:none" href="<?php echo $this->config->item("newsletter_base_url") ; ?>?artist=<?php echo encode($row->artist); ?>&track=<?php echo encode($row->track); ?>" ><?php echo $row->track; ?></a>
